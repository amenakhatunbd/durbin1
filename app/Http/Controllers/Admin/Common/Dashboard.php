...
//            ->get();
        ...
        $data['total_publisher']=Publisher::count();
        $data['total_category']=Category::count();


        $data['pending_product']= Product::where('status',2)->count();
        $data['pending_author']= Author::where('status',2)->count();
        $data['pending_publisher']=Publisher::where('status',2)->count();
        $data['pending_category']=Category::where('status',2)->count();
        ...
        if($user_role == 'Publisher')
        {
            ...
            $data['all_product_publisher'] = Product::where('publisher_id', $user_id)->count();
            $data['all_publish_product_publisher'] = Product::where('publisher_id', $user_id)->where('status',1)->count();
            $data['all_unpublish_product_publisher'] = Product::where('publisher_id', $user_id)->where('status','!=',1)->count();
           
            return view('nptl-admin/common/dashboard/dashboard_publisher', $data);
        }
        else
        {

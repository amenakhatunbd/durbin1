            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="main_nav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{url('category/কর্পোরেট-অর্ডার')}}"> কর্পোরেট অর্ডার </a></li>
                       @php
                        $publishers = \App\Model\Common\Publisher::Published()->select('title','slug','id')->limit(39)->get();
                       @endphp
                        <li class="nav-item dropdown has_megamenu">
                            ...
                            <div class="dropdown-menu megamenu" role="menu">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="col-lg-3 col-6"><a href="{{ url('/publisher', $publisher->slug) }}">{{$publisher->title}}</a></li>
                                   @endforeach
                        ...
                        <li class="nav-item dropdown has_megamenu">
                            ...
                            <div class="dropdown-menu megamenu" role="menu">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="col-lg-3 col-6"><a href="{{ url('/author', $author->slug) }}">{{$author->title}}</a></li>
                                   @endforeach
                       ...
                       @php
                        $categorys = \App\Model\Common\Category::Published()->select('title','slug','id')->limit(39)->get();
                       @endphp
                        <li class="nav-item dropdown has_megamenu">
                            ...
                            <div class="dropdown-menu megamenu" role="menu">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="col-lg-3 col-6"><a href="{{ url('/category', $category->slug) }}">{{$category->title}}</a></li>
                                   @endforeach
                                   <li class="pull-right col-sm-3"><a href="{{ url('/all_categories') }}"> see more.. </a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ url('category', 'দূরবীন-অফার') }}"> দূরবীন অফার  </a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ url('category', 'ইসলামিক-বই') }}"> ইসলামিক বই  </a></li>

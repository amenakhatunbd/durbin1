    ...
    <div class="jarviswidget" id="wid-add-category-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                <div class="col-sm-12">
                        @include("nptl-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'shops'])
                    </div>
                    <div class="col-sm-12">
    ...
    <div class="jarviswidget" id="wid-id-category-publish" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                ...
                if (SM::is_admin() || isset($permission) && isset($permission['shops']['update']) && $permission['shops']['update'] == 1)
                {
                ?>

...
<article class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
    ...
    <div class="jarviswidget" id="wid-add-Customer-main" data-widget-editbutton="false" data-widget-deletebutton="false">
        <!-- widget options:
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="sm-form {{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            @endif
                            <span class="displayNone dark-red username_wr">
                    ...
                    <div class="col-sm-6">
                        <div class="sm-form{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('email', null,['required'=>'','class'=>'form-control', 'placeholder'=>'']) !!}
                            @if ($errors->has('email'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('email') }}</strong>
                                 </span>
                            @endif
                            <span class="displayNone dark-red email_wr">
...
<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <!-- Widget ID (each widget will need unique ID)-->
    <div class="jarviswidget" id="wid-addCustomer-publish" data-widget-editbutton="false" data-widget-deletebutton="false">

        <header>
            <span class="widget-icon"> <i class="fa fa-save"></i> </span>
            <h2>Customer Publish</h2>
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                ...
                <div style="display: none;" class="sm-form{{ $errors->has('lastname') ? ' has-error' : '' }}">
                    {!! Form::label('lastname',__("user.lastname"))!!}
                    {!! Form::text('lastname', null,['class'=>'form-control', 'placeholder'=>__("user.lastname")]) !!}
                ...
                <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                    {!! Form::label('status', 'Admin Customer Publication Status') !!}
            ...
            <div class="widget-body padding-10">
                <div class="col-sm-6">
                    <div class="sm-form{{ $errors->has('street') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('street', null,['class'=>'form-control', 'required'=>'', 'placeholder'=>__("user.street")]) !!}
                ...
                <div class="col-sm-6">
                    <div class="sm-form{{ $errors->has('zip') ? ' has-error' : '' }}">
                        ...
                        {!! Form::number('zip', null,['class'=>'form-control','maxlength'=>'5','required'=>'', 'placeholder'=>__("user.zip")]) !!}
                        @if ($errors->has('zip'))
                            <span class="help-block">
...
?>
@include(('nptl-admin/common/common/image_form'),['header_name'=>'Customer', 'image'=>$image])
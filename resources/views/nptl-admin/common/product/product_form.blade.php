...
<article class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
 ...
 @if ($errors->has('product_english_title'))
                        ...
                        <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('sku', $sku,['class'=>'form-control', 'placeholder'=>'SKU','readonly']) !!}
                            @if ($errors->has('sku'))
                                <span class="help-block">
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                ...
                <div class="sm-form form-group {{ $errors->has('author_id') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('author_id[]', $author_lists, null, ['class'=>'select2 ','multiple'=>'']) !!}
                    @if ($errors->has('author_id'))
                        <span class="help-block dark-red">
                          <strong>{{ $errors->first('author_id') }}</strong>
                       </span>
                ...
                <div class="sm-form form-group {{ $errors->has('translator_id') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('translator_id[]', $author_lists, null, ['class'=>'select2', 'multiple'=>'']) !!}

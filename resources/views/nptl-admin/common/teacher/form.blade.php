    ...
    <div class="jarviswidget" id="wid-add-category-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                <div class="col-sm-12">
                        @include("nptl-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'teachers'])
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            {!! Form::label('description','Teachers Description')!!}

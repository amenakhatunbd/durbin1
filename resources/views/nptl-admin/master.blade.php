...
<body class="smart-style-1">
    ...
    <header id="header">
        ...
        $pendingCategory = \App\Model\Common\Category::where('status', 2)->count();
        $pendingProduct = \App\Model\Common\Product::where('status', 2)->count();
        $pendingAuthor = \App\Model\Common\Author::where('status', 2)->count();
        $pendingPublisher = \App\Model\Common\Publisher::where('status', 2)->count();
                        ...
                        <li>
                            ...
                            <div class="slimScrollDiv">
                                        ...
                                        <a target="_blank"
                                            ...
                                            <h4>
                                                ...
                                                <small>
                                                    ...
                                                    {{ SM::showDateTime($order->created_at) }}
                                                </small>
                                            </h4>
                                ...
                                <div class="slimScrollBar"
                                    style="background: rgb(0, 0, 0); width: 3px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 185.185px;">
                                </div>
                                    ...
                                    <li>
                                        ...
                                        <a href="#">
                                            ...
                                            <h4>
                                                ...
                                                <small>
                                                    <i class="fa fa-clock-o"></i>
                                                    {{ SM::showDateTime($new_user->created_at) }}
                                                </small>
                                            </h4>
                                            <p></p>
                                        </a>
            ...
            <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
                <li class="">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="{{url(SM::smAdminSlug("logout"))}}"
        ...
        <div class="row">
            <div class="col-xs-12">
                <p class="txt-color-white text-center">&copy; <?php echo date('Y'); ?> by
                    ...
                    rights reserved. Design and Developed By <a href="https://nextpagetl.com">Next Page Technology
                        Ltd.</a>
                </p>
            </div>
